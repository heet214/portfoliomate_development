...
function setup_country_list() {
    if (!is_country_list_setup) {
        ...
        for (var i = 0; i < countries_data.length; i++) {
            ...
            output.push('<option data-subtext="' + countries_data[i].code + '" value="' + countries_data[i].name + '">' + countries_data[i].name + '</option>');
        };
...
function setup_startup_sector_list() {
    if (!is_startup_sector_list_setup) {
        ...
        for (var i = 0; i < sectors_data.length; i++) {
            ...
            output.push('<option data-subtext="' + sectors_data[i].IndustryGroups + '" value="' + sectors_data[i].IndustryName + '">' + sectors_data[i].IndustryName + '</option>');
        };
...
var user_data = {}; var parent_stakeholder = {};
                ...
                case 'startup':
                    {
                        ...
                        window.location.href = "../accelerator_dashboard/stakeholder_management?action=" + data.stakeholder_type + "";
                        break;
                    }
