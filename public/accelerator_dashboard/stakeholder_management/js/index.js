...
function populate_startups_table(stakeholders) {
    ...
    for (var i = 0; i < startups.length; i++) {
        ...
        table.append(
            ...
            '</div>' +
            '<div class="company_title_holder">' + startups[i].company_name + '</div>' +
            '</div>' +
            "</td>" +
            ...
            '<div onclick="start_enagagement(\'' + startups[i].id + '\')" class="dropdown-item ' + itemshow[2] + '">Start Enagement</div>' +
            '<div onclick="view_enagement(\'' + startups[i].id + '\')" class="dropdown-item ' + itemshow[3] + '">View Enagagements</div>' +
            '</div>' +
            '</div>' +
            '</td>' +
            "</tr>");
...
function populate_investors_table(stakeholders) {
    ...
    for (var i = 0; i < investors.length; i++) {
        ...
        table.append(
            ...
            '</div>' +
            '<div class="company_title_holder">' + investors[i].company_name + '</div>' +
            '</div>' +
            "</td>" +
            ...
            '<div onclick="start_enagagement(\'' + investors[i].id + '\')" class="dropdown-item ' + itemshow[2] + '">Start Enagement</div>' +
            '<div onclick="view_enagement(\'' + investors[i].id + '\')" class="dropdown-item ' + itemshow[3] + '">View Enagagements</div>' +
            '</div>' +
            '</div>' +
            '</td>' +
            "</tr>");
...
function populate_innovadors_table(stakeholders) {
    ...
    for (var i = 0; i < innovadors.length; i++) {
        ...
        table.append(
            ...
            '<div onclick="complete_stakeholder_profile(\'' + innovadors[i].id + '\')" class="dropdown-item ' + itemshow[0] + ' ">Complete Profile</div>' +
            '<div onclick="view_stakeholder_profile(\'' + innovadors[i].id + '\')" class="dropdown-item ' + itemshow[1] + '">View Profile</div>' +
            '<div onclick="start_enagagement(\'' + innovadors[i].id + '\')" class="dropdown-item ' + itemshow[2] + '">Start Enagement</div>' +
            '<div onclick="view_enagement(\'' + innovadors[i].id + '\')" class="dropdown-item ' + itemshow[3] + '">View Enagagements</div>' +
            '</div>' +
            '</div>' +
            '</td>' +
            "</tr>");
...
function complete_stakeholder_profile(stakeholder_id) {
    window.location.href = "../../accelerator_dashboard/stakeholder_management/modules/profile/?action=" + stakeholder_id + "";
}
