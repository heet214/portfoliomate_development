...
function openApproachedModal(dataID, type) {
  ...
  if (type == null) {
    ...
    link =
      'https://portfoliomate-e14a8.web.app/accelerator_dashboard/stakeholder_management/modules/profile/?stakeholder_id=' +
      dataID +
      '?action=edit';
  ...
  for (var i = 0; i < data.length; i++) {
    if (data[i].fundraiser.sub_engagements) {
      for (var j = 0; j < data[i].fundraiser.sub_engagements.length; j++) {
        switch (
          data[i].fundraiser.sub_engagements[j].status[
            data[i].fundraiser.sub_engagements[j].status.length - 1
          ].type
        ) {
          case 'Approached':
            $('.Approached-container').append(
              populate_Approached_kanban(data[i], j)
            );
            // contenthide();
            break;
          case 'interested':
            $('.Interested-container').append(
              populate_Interested_kanban(data[i], j)
            );
            // contenthide();
            break;
          case 'notInterested':
            $('.notInterested-container').append(
              populate_notInterested_kanban(data[i], j)
            );
            break;
          case 'meetingScheduled':
            $('.meet-container').append(
              populate_meetingScheduled_kanban(data[i], j)
            );
            break;
          case 'meetingReScheduled':
            $('.rescheduled-container').append(
              populate_rescheduled_kanban(data[i], j)
            );
            break;
          case 'InterestReceivedUnderDiscussion':
            $('.InterestReceivedUnderDiscussion-container').append(
              populate_InterestReceivedUnderDiscussion_kanban(data[i], j)
            );
            break;
          case 'pitchingDone':
            $('.pitchingDone-container').append(
              populate_pitchingDone_kanban(data[i], j)
            );
            break;

          case 'SoftCommitment':
            $('.softCommitment-container').append(
              populate_softCommitment_kanban(data[i], j)
            );
            break;
          case 'dueDiligence':
          ...
          case 'termSheetReceived':
            $('.termSheetReceived-container').append(
              populate_termSheetReceived_kanban(data[i], j)
            );
            break;
          case 'termSheetSigned':
            $('.termSheetSigned-container').append(
              populate_termSheetSigned_kanban(data[i], j)
            );
            break;
          case 'fundsTransfer':
            $('.fundsTransfered-container').append(
              populate_fundsTransfered_kanban(data[i], j)
            );
            break;
          case 'roundClosed':
            $('.roundClosed-container').append(
              populate_roundClosed_kanban(data[i], j)
            );
            break;
        }
      }
    } else {
      $('.notApproached-container').append(
        populate_notApproached_kanban(data[i]),
        j
      );
    }
  }
...
function populate_notApproached_kanban(data, count) {
  ...
  count_notApproached++;
  var url =
    'https://firebasestorage.googleapis.com/v0/b/portfoliomate-e14a8.appspot.com/o/WhatsApp%20Image%202022-06-26%20at%204.37.51%20PM.jpeg?alt=media';
  ...
  let li =
    ...
    "<div class='dropdown-item' onclick='openApproachedModal(" +
...
function populate_Approached_kanban(data, count) {
  ...
  var li =
    ...
    'style="color:#FFCAC8;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    "<div class='dropdown-item' onclick='update_Status_to_Interested(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Interested</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_NotInterested(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Not Interested</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_meetScheduled(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Meet Scheduled</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_reSchedule(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Reschedule</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_irud(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Under Discussion</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_pitchingDone(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Pitching Done</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_committed(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Soft Commitment</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_DD(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Due Diligence</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_termSheetReceived(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Term Sheet Received</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_termSheetSigned(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Term Sheet Signed</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_fundsTransfer(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    '>Funds Transfered</div>' +
    "<div class='dropdown-item' onclick='update_Status_to_roundClose(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    ...
    data.fundraiser.sub_engagements[count].status[
      data.fundraiser.sub_engagements[count].status.length - 1
    ].description +
    '</p>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_approached(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_Interested_kanban(data, count) {
  ...
  var li =
    ...
    'style="color:#C5C0C0;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    "<div class='dropdown-item' onclick='update_Status_to_approached(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'" +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_Interested(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_notInterested_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#fdfd96;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_NotInterested(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_meetingScheduled_kanban(data, count) {
  console.log(
    'meet ' + data.fundraiser.sub_engagements[count].sub_engagement_id
  );
  ...
  li =
    ...
    'style="color:#C8DBBE;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_meetScheduled(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_rescheduled_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#E7B7A6;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_reSchedule(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_InterestReceivedUnderDiscussion_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#A4C9D7;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_irud(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_pitchingDone_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#FFDBA4;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_pitchingDone(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_softCommitment_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#D2DAFF;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_committed(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_dd_kanban(data, count) {
  ...
  var li =
    ...
    'style="color:#EFEAD8;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_DD(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_termSheetReceived_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#FF9F9F;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png'onclick='update_Status_to_termSheetReceived(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_termSheetSigned_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#9E7676;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_termSheetSigned(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_fundsTransfered_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#9ED2C6;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_fundsTransfer(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
...
function populate_roundClosed_kanban(data, count) {
  ...
  li =
    ...
    'style="color:#AF7AB3;display: flex;border-top-left-radius:20px;margin-left:6px;width:8.5rem;justify-content: center;  height: fit-content;padding:5px">' +
    '<div style="line-height:9px">' +
    data.fundraiser.sub_engagements[count].company_from.from_name +
    '</div>' +
    '</div>' +
    ...
    '<div class="options">' +
    '<div class="edit">' +
    "<img style='height:20px;width:20px;object-fit:contain;' src='../../../../assets/edit_icon2.png' onclick='update_Status_to_roundClose(" +
    JSON.stringify(data) +
    ',' +
    count +
    ")'/>" +
      ...
      form.addEventListener(
        ...
        function (event) {
          if (!form.checkValidity()) {
            ...
            let status = {
              changed_by: '',
              description: document.getElementById('meetingScheduledNote')
                .value,
      ...
      form.addEventListener(
        ...
        function (event) {
          if (!form.checkValidity()) {
            ...
            let status = {
              changed_by: '',
              description: document.getElementById('meetingreScheduledNote')
                .value,
              meet_date: document.getElementById('meetingreScheduleddate')
                .value,
              meet_time: document.getElementById('meetingreScheduledtime')
                .value,
